 ...
 *
*/
#ifndef GZ_SIM_NASA_PDS_DTM_IMPORTER_SYSTEM_HH_
#define GZ_SIM_NASA_PDS_DTM_IMPORTER_SYSTEM_HH_
...
namespace systems
{
  /// \brief Private data class for NasaPdsDtmImporter Plugin
  class NasaPdsDtmImporterPrivate;

  /** \class NasaPdsDtmImporter NasaPdsDtmImporter.hh \
   * gz/sim/systems/NasaPdsDtmImporter.hh
  **/
  ...
  class NasaPdsDtmImporter:
    public System,
    public ISystemConfigure
  {
    /// \brief Constructor
    public: NasaPdsDtmImporter();

    /// \brief Destructor
    public: ~NasaPdsDtmImporter() override = default;
    ...
    private: std::unique_ptr<NasaPdsDtmImporterPrivate> dataPtr;
  };
}
}
}
